    ...
    public class Menu
    {
        public void menuPrincipal()
        {
           ...
           while (!salir)
           {
                ...
                Console.SetCursorPosition(48, 11); Console.WriteLine("5. Opciones De Registro");
        ...
        {
            GestionMovimiento gestionMovimiento = new GestionMovimiento();
            int opcion;
            string opcionMenu;
            bool salir = false;
            ...
            while (!salir)
            {
                Console.ForegroundColor = ConsoleColor.DarkYellow;
                Console.SetCursorPosition(53, 4); Console.Write("Oro Select");
                Console.SetCursorPosition(49, 5); Console.Write("Opciones De Registro");
                Console.ForegroundColor = ConsoleColor.White;
                Console.SetCursorPosition(48, 7); Console.WriteLine("1. Movimientos");
                Console.SetCursorPosition(48, 8); Console.WriteLine("2. Contratos Pendientes");
                Console.SetCursorPosition(48, 9); Console.WriteLine("3. Volver Al Menu Principal ");
                Console.ForegroundColor = ConsoleColor.DarkYellow;
                ...
                switch (opcion)
                {
                    case 1:
                        Console.Clear();
                        gestionMovimiento.listaMovimientos();
                        break;
                    case 2:
                        Console.Clear();
                        gestionMovimiento.contratosPendientes();
                        break;
                    case 3:
                        Console.Clear();
                        salir = true;
