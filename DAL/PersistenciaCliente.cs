...
namespace DAL
{
    ...
    {
        public void sobreescribirClientesEnArchivo(List<Cliente> clientes, string nombreArchivo)
        {
            try
            {
                ...
                using (StreamWriter writer = new StreamWriter(rutaArchivo))
                {
                    foreach (var cliente in clientes)
                    {
                        ...
                        writer.WriteLine($"{cliente.codigoCliente},{cliente.id},{cliente.apellido},{cliente.nombre},{cliente.telefono},{cliente.direccion}");
                    }
                }
            }
            catch (Exception ex)
        ...
        //
        public void GuardarClienteEnArchivo(Cliente cliente, string nombreArchivo)
        {
            try
            {
                // Obtener la ruta del directorio actual donde se encuentra el ejecutable
        ...
        public List<Cliente> LeerClientesDesdeArchivo(string nombreArchivo)
        {
